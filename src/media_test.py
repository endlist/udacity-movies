...
def test_get_movie_search_query_returns_query_with_title():
    ...
    api_query_string = urljoin(test_movie.BASE_API_URL, 'search/movie?query=' + movie_title + '&api_key=' + test_movie.API_KEY)

    eq_(test_movie.get_movie_search_query_string(movie_options), api_query_string)
...
def test_get_movie_query_returns_query_with_id():
    ...
    api_query_string = urljoin(test_movie.BASE_API_URL, 'movie/' + str(movie_id) + '?api_key=' + test_movie.API_KEY)
...
def test_get_movie_video_query_returns_query_with_id():
    ...
    movie_id = 12
    movie_options = { 'id': movie_id }
    api_query_string = urljoin(test_movie.BASE_API_URL, 'movie/' + str(movie_id) + '/videos?api_key=' + test_movie.API_KEY)

    eq_(test_movie.get_movie_video_query_string(movie_options), api_query_string)
